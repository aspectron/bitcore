...
*/
var HierarchicalKey = function(bytes, litecoin) {
  this.litecoin = litecoin;
  if (typeof bytes == 'undefined' || bytes == 'mainnet' || bytes == 'livenet') {
    bytes = 'livenet';    
    this.version = this.litecoin ? networks[this.litecoin]['livenet'].hkeyPrivateVersion : networks['livenet'].hkeyPrivateVersion;
  } else if (bytes == 'testnet') {
    this.version = this.litecoin ? networks[this.litecoin]['testnet'].hkeyPrivateVersion : networks['testnet'].hkeyPrivateVersion;
  }
...
HierarchicalKey.seed = function(bytes, network, litecoin) {
  if (!network)
    network = 'livenet';
...
HierarchicalKey.prototype.initFromBytes = function(bytes) {
  ...
  if(this.litecoin){
    networks['livenet'] = networks[this.litecoin]['livenet'];
    networks['testnet'] = networks[this.litecoin]['testnet'];
  }
