...
var HierarchicalKey = function(bytes, litecoin) {
  ...
  if (typeof bytes == 'undefined' || bytes == 'mainnet' || bytes == 'livenet') {
    bytes = 'livenet';    
    this.version = this.litecoin ? networks['ltc']['livenet'].hkeyPrivateVersion : networks['livenet'].hkeyPrivateVersion;
  } else if (bytes == 'testnet') {
    this.version = this.litecoin ? networks['ltc']['testnet'].hkeyPrivateVersion : networks['testnet'].hkeyPrivateVersion;
  }
