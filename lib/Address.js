...
Address.fromPubKey = function(pubKey, network, litecoin) {        
    ...
    if (litecoin)
        networks[network] = networks['ltc'][network];
...
Address.prototype.network = function() {
    ...
    var livenet = this.litecoin ? networks['ltc'].livenet : networks.livenet;
    var testnet = this.litecoin ? networks['ltc'].testnet : networks.testnet;
